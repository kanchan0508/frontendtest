...
function CoachHeroSection() {
  return (
    <section className="relative w-full overflow-hidden rounded-[20px] bg-[#8bc1f4] px-4 py-6 sm:px-6 md:px-10 md:py-8 2xl:min-h-[390px]">
...
function EmptyCoachesSection() {
  return (
    <section className="relative mb-8 w-full overflow-hidden rounded-[24px] bg-[#f7f9fc] px-4 py-8 sm:px-6 md:px-8 md:py-10">
